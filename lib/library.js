...
function getOrientation (dimension) {
  if (dimension === DIMENSION.w) {
    return ORIENTATION.horizontal;
  } else if (dimension === DIMENSION.h) {
...
function addPatchBefore (currentPatch, newPatch, dimension) {

}

function addPatchAfter (currentPatch, newPatch, dimension) {

}

function prependPatch (currentPatch, newPatch, dimension) {

}

function appendPatch (currentPatch, newPatch, dimension) {

}

function combinePatch (currentPatch, newPatch, placement) {
  console.log(getOrientation(placement))
};
